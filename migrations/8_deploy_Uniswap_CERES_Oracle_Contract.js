...
module.exports = async function(deployer, network, accounts) {
	...
	// await Promise.all([
	// 	deployer.deploy(StakingRewards_CERES_WETH, STAKING_OWNER, STAKING_REWARDS_DISTRIBUTOR, cssInstance.address, pair_addr_CERES_WETH, ceresInstance, timelockInstance.address, 500000),
	// 	deployer.deploy(StakingRewards_CERES_USDC, STAKING_OWNER, STAKING_REWARDS_DISTRIBUTOR, cssInstance.address, pair_addr_CERES_USDC, ceresInstance, timelockInstance.address, 500000),
	// 	deployer.deploy(StakingRewards_CSS_WETH, STAKING_OWNER, STAKING_REWARDS_DISTRIBUTOR, cssInstance.address, pair_addr_CSS_WETH, ceresInstance, timelockInstance.address, 0)
	// ]);
}
