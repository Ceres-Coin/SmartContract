...
contract CEREShares is ERC20Custom, AccessControl {
    ...
    // [LATER], using POOLS TO pool_burn_from
    ...
    function trackVotes(address srcRep, address dstRep, uint96 amount) internal {
        if (srcRep != dstRep && amount > 0) {
            if (srcRep != address(0)) {
                ...
                uint96 srcRepNew = sub96(srcRepOld, amount, "CSS::_moveVotes: vote amount underflows");
            ...
            if (dstRep != address(0)) {
                ...
                uint96 dstRepNew = add96(dstRepOld, amount, "CSS::_moveVotes: vote amount overflows");
