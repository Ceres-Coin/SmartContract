...
contract('oracle_instance_CSS_USDC', async (accounts) => {
	// deploy address;
	let ADMIN;
	...
	// // Always Passed
	// // No Assertion
	it("oracle_instance_CSS_USDC Initialize", async () => {
		console.log(chalk.red("============ oracle_instance_CSS_USDC Initialize ============"));
		console.log(chalk.green.bold("NO ASSERTION"));
		console.log(chalk.green.bold("first_CSS_USDC: ",first_CSS_USDC));

		console.log(chalk.yellow("oracle_instance_CSS_USDC: ",oracle_instance_CSS_USDC.address));
	...
	it("oracle_instance_CERES_USDC timelock_address", async () => {
		...
		// Action
		const ar_timelock_address = await oracle_instance_CERES_USDC.timelock_address.call();
